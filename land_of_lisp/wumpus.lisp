...
(defun add-cops (edge-alist edges-with-cops)
  "Returns a list containing lists whose cars are nodes and cdrs are lists
of single edges, possibly with 'cops. For example, ((22 (23)) (24 (15) (4
COPS)))."
  (mapcar (lambda (x)
            (let ((node1 (car x))
                  (node1-edges (cdr x)))
...
(defun edges-to-alist (edge-list)
  "Returns a list containing lists whose cars are nodes and cdrs are lists
of single edges. For example, ((22 (23)) (24 (15) (4)) (23 (22)))."
  (mapcar (lambda (node1)
            (cons node1
                  (mapcar (lambda (edge)
                            (list (cdr edge)))
  ...
  (let* ((node (assoc pos *congestion-city-nodes*))
    ...
    (cond ((member 'cops edge) (princ "You ran into the cops. Game Over."))
          ((member 'wumpus node) (if charging
                                     (princ "You found the Wumpus and shot him! You Win!")
                                   (princ "You ran into the Wumpus, who attacks. Game Over.")))
          (charging (princ "You wasted your last bullet. Game Over."))
          (has-worm (let ((new-pos (random-node)))
                      (princ "You ran onto a Glow Worm Gang! You're now at ")
                      (princ new-pos)
